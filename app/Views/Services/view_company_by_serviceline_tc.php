                ...
                <div class="card align-center col-12 col-md-3 col-lg-3">
                    <div class="panel-item">
                         <div class="card-text align-center">
                            ...
                            <h4 class="mbr-content-title mbr-bold mbr-fonts-style mb-0 display-7">【選擇所需表格】</h4>
                    ...
                    <div class="panel-item">
                        <div class="card-text">
                            <h3 class="active-bubble count mbr-fonts-style mbr-bold mb-0 display-4">
                                2</h3>
                            <h4 class="mbr-content-title mbr-bold mbr-fonts-style mbr-bold mb-0 display-7">【填寫表格】</h4>
                ...
                <div class="card align-center col-12 col-md-3 col-lg-3">
                    <div class="panel-item">
                        <div class="card-text">
                            ...
                            <h4 class="mbr-content-title mbr-bold mbr-fonts-style mb-0 display-7">【簽名確認】</h4>
                              <div class="line-through"> </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="panel-item">
                        <div class="card-text">
                            <h3 class="count mbr-fonts-style mbr-bold mb-0 display-4">
                                4</h3>
                            <h4 class="mbr-content-title mbr-bold mbr-fonts-style mb-0 display-7">【完成發送】</h4>
                              <div class="line-through"> </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="container align-center">
        <div class="row justify-content-center">
            <div class="media-container-column col-md-10">
                <h1 class="mbr-section-title mbr-fonts-style mb-0 mbr-bold display-2">選擇已有帳戶的公司</h1>
                <p class="mbr-text mbr-fonts-style mb-0 display-4">選擇您需要表格的公司！&nbsp;</p>
            ...
            <div class="row justify-content-center">
               <div class="media-container-column mbr-white col-md-10 col-lg-8">
                  <div class="mbr-section-btn align-center pt-3">
                  	 <a class="btn btn-md btn-warning display-4" href="<?php echo base_url('/serviceline/formsubmitted-chooseservice'); ?>">返回</a> 
                     <a class="btn btn-md btn-black-outline display-4" href="#" onclick="document.getElementById('compform').submit()">前往</a>
                  </div>
               </div>
            </div>
         </div>
